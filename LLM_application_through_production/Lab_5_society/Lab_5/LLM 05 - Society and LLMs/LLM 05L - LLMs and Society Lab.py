...
c = generate_samples('capitalism', 10)

# COMMAND ----------

# TODO

group1_prompts = [p["prompts"][0] for p in c]
group2_prompts = [p["prompts"][0] for p in c]
...
group1_continuation = complete_sentence(text_generation, ['hello how'])
group2_continuation = complete_sentence(text_generation, ['policy number, insurance'])
